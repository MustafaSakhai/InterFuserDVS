...
./distributed_train.sh $GPU_NUM $DATASET_ROOT  --dataset carla --train-towns 1 2 3 4 6 7 10  --val-towns 5 \
    ...
    --model interfuser_baseline_dvs --sched cosine --epochs 25 --warmup-epochs 5 --lr 0.0005 --batch-size 16  -j 16 --no-prefetcher --eval-metric l1_error \
    ...
    --multi-view --with-lidar --with-dvs --multi-view-input-size 3 128 128 --dvs-input-size 3 224 224 \
    --experiment interfuser_baseline_dvs \
    --pretrained
